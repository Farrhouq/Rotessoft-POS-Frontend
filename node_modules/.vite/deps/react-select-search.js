...
function $0d0f732c1d5a71da$export$2e2bcd8739ae039({ options: defaultOptions, defaultValue, value, multiple, search, onChange = $0d0f732c1d5a71da$var$nullCb, onFocus = $0d0f732c1d5a71da$var$nullCb, onBlur = $0d0f732c1d5a71da$var$nullCb, closeOnSelect = true, placeholder, getOptions, filterOptions, useFuzzySearch = true, debounce }) {
  ...
  const onSelect = (v) => {
    ...
    if (value === void 0) setOption(newOption);
...
function $1b5fcad01c07e709$var$Options(props) {
  ...
  return (0, import_jsx_runtime.jsx)("ul", {
    ...
    children: options.map((o) => {
      if (o.type === "group") return (0, import_jsx_runtime.jsx)("li", {
        role: "none",
        className: cls("row"),
...
var $00d3317695af813e$var$SelectSearch = (0, import_react.forwardRef)(({ disabled, placeholder, multiple, search, autoFocus, autoComplete = "on", id, closeOnSelect = true, className = "select-search", renderValue, renderOption, renderGroupHeader, fuzzySearch = true, emptyMessage, value, debounce = 250, printOptions = "auto", options = [], ...hookProps }, ref) => {

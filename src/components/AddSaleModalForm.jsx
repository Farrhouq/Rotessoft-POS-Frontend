...
function AddSale({ modalOpen, setModalOpen }) {
  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="bg-white w-screen dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl max-h-full rounded-lg shadow-lg"
        >
          {/* Search form */}
          <form className="border-b w-full border-gray-200 dark:border-gray-700/60 px-3 py-5">
